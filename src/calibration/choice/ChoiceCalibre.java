...
import calibration.mstorm_sensor_calibration.LightAndColorSensor;
import calibration.mstorm_sensor_calibration.SensorType;

public class ChoiceCalibre {

	public final static int NUMCHANS = 4;
	public final static String ch_gumi = "choice.gumi";
	...
	public static void main(String [] args) throws IOException{
		...
		try{
			...
			PrintWriter w = new PrintWriter(new BufferedWriter(new FileWriter(ch_gumi, false)));
			w.printf("%.9g\n%.9g\n%.9g\n",r_avg,g_avg,b_avg);
			w.flush();
			w.close();
			sensor.close();
